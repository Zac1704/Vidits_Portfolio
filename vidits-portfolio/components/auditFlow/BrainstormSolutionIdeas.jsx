      ...
      <div className="max-w-6xl mx-auto px-6 py-24">
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div>
            ...
            {/* Subtitle */}
            <p className="font-inter font-medium text-lg md:text-xl text-gray-900 mb-16">
              Using the How Might We question, I explored multiple solution
              ideas.
            </p>
            <div className="flex-1 space-y-10">
              ...
              <ul className="font-inter space-y-8 text-base md:text-lg lg:text-xl text-gray-800 font-medium italic leading-relaxed">
