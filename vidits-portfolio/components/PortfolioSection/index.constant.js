...
export const SECONDARY_IMAGES = [
  {
    ...
    images: {
      className: "ml-10 -mt-25 lg:ml-50 lg:-mt-30",
      width: 240,
      height: 288,
    },
    note: {
      ...
      className:
        "z-40 -ml-40 lg:ml-0 lg:mt-20 w-[156.83px] h-[156px] bg-[#9B1B25] text-white p-3 shadow-xl tracking-wider max-w-xs",
    },
  },
  {
    ...
    images: {
      className: "ml-10 -mt-25 lg:ml-10 lg:-mt-80",
      width: 189,
      height: 227,
    },
    note: {
      ...
      className:
        "z-40 -ml-40  lg:mt-30 lg:ml-60  bg-[#FFB629] text-white w-[143px] h-[178px] p-3 tracking-wider shadow-xl max-w-xs",
    },
  },
  {
    src: "/Images/Portfolio/image3.png",
    images: {
      className: "ml-10 -mt-25 lg:ml-5 lg:-mt-28",
      width: 205,
      height: 205,
    },
    note: {
      ...
      className:
        "z-40 -ml-40 lg:-mt-5 lg:-ml-50 w-[143px] h-[112px] p-3 tracking-wider bg-[#276A96] text-white shadow-xl max-w-xs",
    },
  },
  {
    src: "/Images/Portfolio/image4.png",
    images: {
      className: "ml-10 -mt-25 lg:-ml-10  lg:-mt-20",
      width: 262,
      height: 259,
    },
    note: {
      ...
      className:
        "z-40 -ml-40  lg:mt-0 lg:-ml-50  w-[143px] h-[156px] bg-[#0E7F01] text-white p-3 tracking-wider shadow-xl max-w-xs",
    },
  },
];
