...
export default function Footer() {
  return (
    <section id="contact" className="bg-(--text-color) text-white pt-12 pb-7 px-6 md:px-12 lg:px-25 scroll-mt-24">
      <div>
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
          ...
          <div className="flex-1 space-y-1 sm:space-y-2">
            ...
            <h2
              ...
              className="text-white text-5xl md:text-6xl lg:text-8xl font-black leading-tight"
            >
              LET&apos;S CONNECT
            </h2>
        ...
        <div className="mt-12 pt-5 border-t-[2px] border-[#D2D2D2]/50 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex gap-4">
            <Link
              href="https://www.behance.net/viditshah5"
              target="_blank"
