export default function Footer() {
  return (
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
          ...
          <div className="flex flex-col gap-6 lg:min-w-[300px]">
            ...
            <a
              ...
              className="cursor-pointer rounded-full p-[1px] bg-gradient-to-br from-gray-700 via-gray-800 to-black shadow-[0_8px_32px_rgba(0,0,0,0.4)] group"
            >
              <div className="rounded-full bg-black/60 backdrop-blur-md shadow-[inset_0_4px_16px_rgba(255,255,255,0.05)] relative flex items-center gap-4 px-8 py-4 overflow-hidden">
            ...
            {/* WhatsApp Button */}
            <a
              href="https://wa.me/+917869963454"
              target="_blank"
              rel="noopener noreferrer"
              className="group relative flex items-center justify-center gap-4 px-10 py-4 rounded-full 
    bg-gradient-to-br from-[#2b2b2b] via-[#1c1c1c] to-[#0a0a0a]
    shadow-[inset_2px_2px_6px_rgba(0,0,0,0.8),inset_-2px_-2px_6px_rgba(255,255,255,0.06),0_4px_12px_rgba(0,0,0,0.5)]
    hover:shadow-[inset_1px_1px_4px_rgba(0,0,0,0.9),inset_-1px_-1px_4px_rgba(255,255,255,0.12),0_6px_16px_rgba(0,0,0,0.7)]
    transition-all duration-300 ease-out transform hover:scale-105 active:scale-100
    ...
    translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-700 ease-in-out"
              ...
              {/* WhatsApp Icon */}
              <div
                className="relative flex items-center justify-center bg-white rounded-full p-1.5 
    shadow-[inset_0_2px_4px_rgba(0,0,0,0.25),0_2px_8px_rgba(37,211,102,0.3)]
    group-hover:shadow-[inset_0_2px_4px_rgba(0,0,0,0.3),0_4px_12px_rgba(37,211,102,0.5)]
    transition-all duration-300 group-hover:scale-110"
              ...
              <span
                className="relative text-white text-2xl font-extrabold tracking-wider z-10
    group-hover:text-white/95 transition-colors duration-300"
              >
                WHATSAPP
                <span
                  className="absolute left-0 bottom-0 h-[2px] w-full bg-gradient-to-r from-white/60 via-white to-white/60 
      rounded-full scale-x-100 group-hover:scale-x-110 transition-transform duration-300 origin-center"
                />
              </span>
            </a>
          </div>
