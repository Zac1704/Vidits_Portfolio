  ...
  return (
    ...
    >
      <div>
        ...
        <div className="space-y-6 text-lg md:text-xl text-[#363636] opacity-90 leading-relaxed font-medium">
          <motion.p variants={itemVariants}>
            Hi, I&apos;m Vidit. I enjoy understanding why people struggle with
            certain digital experiences and how small design decisions can make
            things clearer, smoother, and more intuitive.
          </motion.p>
          <motion.p variants={itemVariants}>
            My journey into design wasn&apos;t straightforward. In college I
            initially explored coding, but toward the end of my third year I
            discovered UI/UX design and felt naturally drawn to its blend of
            creativity and problem-solving.
          </motion.p>
          <motion.p variants={itemVariants}>
            A lesson from my childhood still shapes how I design today. My
            mother once told me,{" "}
            <span className="italic">
              &ldquo;Before doing something to someone, pause and ask how
              you&apos;d feel if it were done to you,&rdquo;
            </span>{" "}
            and that idea of empathy became the foundation of my design process.
          </motion.p>
        </div>
      </div>
      ...
      <motion.div
        ...
        className="mt-8 pt-8 border-t border-gray-200  relative"
      >
        <span className="text-sm font-semibold text-[#a3a3a3] mb-4 block">
          Design Snapshot
        </span>

        <div className="flex flex-wrap gap-6 md:gap-13">
          <div className=" text-(--text-color) ">
            <div className="flex">
              <Odometer value="2+" label="Instagram" />
              <span className="items-baseline font-bold text-xl md:text-2xl tracking-tight pl-2">
                Years
              </span>
            </div>
            <span className="items-baseline font-bold text-sm tracking-tight text-[#a3a3a3]">
              Design Experience
            </span>
          </div>
          <div className="text-(--text-color)">
            <div className="flex">
              <Odometer value="15+" label="TikTok" />
              <span className="items-baseline font-bold text-xl md:text-2xl tracking-tight pl-2">
                Projects
              </span>
            </div>
          ...
          <div className="text-(--text-color)">
            <div className="flex">
              <Odometer value="10+" label="YouTube" />
              <span className="items-baseline font-bold text-xl md:text-2xl tracking-tight pl-2">
                Clients
              </span>
            </div>
